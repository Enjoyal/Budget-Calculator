...
function budgetCalc(){
    ...
    result.innerHTML=``;
    result.innerHTML=` <p class=" text-success fs-5 ">Hi ${uname.value}, <br> After your expenses you have <br> <span class=" text-danger" >${balance} Rs</span> left in your budget.<br> <br> Your Total expense: <span class=" text-danger" >${expense} Rs </span></p> <br>
